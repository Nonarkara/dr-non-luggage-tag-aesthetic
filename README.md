...
<p align="center">
  <img src="assets/hero-tag.webp" alt="White thermal baggage tag: destination BKK dominant, Code 128 license plate 0217123456 secondary, claim stubs as backup." width="100%">
</p>
...
Open `examples/gallery/index.html` in a browser. Copy `design-tokens/tokens.css` and `components/tag-system.css` into your surface. Rebuild **one** object until it is a tag.
