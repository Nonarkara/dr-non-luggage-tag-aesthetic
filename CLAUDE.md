...
3. **[`skill/white-baggage-tag-aesthetic/SKILL.md`](skill/white-baggage-tag-aesthetic/SKILL.md)** — the full invocable skill.
4. **[`docs/lineage.md`](docs/lineage.md)** — why this object is worth copying, and where it goes further than Rams or Vignelli.
5. **[`components/index.html`](components/index.html)** — the live gallery. Reference it; do not invent variants.
